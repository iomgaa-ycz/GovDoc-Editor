...
<HARD-GATE>
The ONLY permitted execution path is subagent-driven-development. Do NOT offer "Inline Execution", do NOT use regular Claude Code subagents as implementers, do NOT implement tasks directly in this session. There is NO alternative. Violations: using Agent tool for implementation, writing code in this session, dispatching Claude Code subagents instead of Codex.
</HARD-GATE>

After saving the plan, announce:

**"Plan complete and saved to `research-wiki/plans/<filename>.md`. Proceeding with Subagent-Driven Development — Codex implements each task, followed by mandatory three-stage Claude Code review (spec compliance → functional quality → code style)."**

- **REQUIRED SUB-SKILL:** Use superpowers:subagent-driven-development
- Fresh Codex session per task + mandatory three-stage review
- Do NOT proceed without invoking subagent-driven-development
