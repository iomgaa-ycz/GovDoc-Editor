...
class TestGetOrConvert:
    ...
    def test_supported_formats_call_to_markdown(
        ...
        mock_to_md.assert_called_once_with(raw_file, ocr_backend="mineru", max_workers=1, timeout=3600)
    ...
    def test_ocr_backend_passed_through(
        ...
        mock_to_md.assert_called_once_with(raw_file, ocr_backend="monkey", max_workers=1, timeout=3600)
